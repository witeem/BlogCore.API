...
public interface ISugarHelperClient<TEntity> : IRepositoryCore where TEntity : class
{
    #region 新增操作
    ...
    /// <returns></returns>
    Task<List<TEntity>> QueryPageListAsync(Expression<Func<TEntity, bool>> whereLambda, ApiPageRequest pageRequest,
